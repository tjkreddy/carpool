...
import { User, Edit3, Star, Car, MapPin, Phone, Mail, Calendar } from 'lucide-react';
import { getCurrentUser, updateProfile, getCollegeById } from '@/lib/auth';
...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      const userRatings = ratingsStorage.getUserRatings(currentUser.id);
      const rating = ratingsStorage.calculateUserRating(currentUser.id);
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{college?.name || 'Unknown College'}</p>
                    </div>
                  </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentRatings.map((rating) => (
                    <div key={rating.id} className="border-l-4 border-l-blue-500 pl-4">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">{stats.completedRides}</div>
