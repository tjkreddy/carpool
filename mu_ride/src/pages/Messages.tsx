      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Chat with drivers and passengers</CardDescription>
          </CardHeader>
            ...
            {conversations.length > 0 ? (
              <div className="space-y-0">
                {conversations.map((conversation) => {
                  ...
                  const ride = ridesStorage
                    .getRides()
                    .find((r) => r.id === conversation.rideId);
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {(() => {
                        const ride = ridesStorage
                          .getRides()
                          .find((r) => r.id === selectedConversation.rideId);
                        return ride
                          ? `${ride.fromLocation.city} → ${ride.toLocation.city}`
                          : "Ride chat";
                      })()}
